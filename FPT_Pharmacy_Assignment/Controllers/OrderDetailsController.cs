...
namespace FPT_Pharmacy_Assignment.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public OrderDetailsController(FPT_Pharmacy_AssignmentContext context)
        {
            _context = context;
        }
        ...
        {
            var fPT_Pharmacy_AssignmentContext = _context.OrderDetail.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> Create([Bind("OrderDetailId,OrderId,ProductId,Quantity")] OrderDetail orderDetail)
        {
            ...
            ViewData["OrderId"] = new SelectList(_context.Order, "OrderId", "Status", orderDetail.OrderId);
